    ...
    if (wishlist.isEmpty) {
      return Directionality(
        ...
        child: Scaffold(
          appBar: AppBar(title: Text(translate('wishlist', selectedLanguage))),
          body: Center(
              child: Text(translate('empty_wishlist', selectedLanguage))),
        ),
      );
    }
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading:
                        item.returnedImg != null && item.returnedImg!.isNotEmpty
                    ...
                    subtitle: Text(
                        '${translate('price', selectedLanguage)}: ${item.price?.toStringAsFixed(2) ?? ''} \MRU'),
                    trailing: Row(
